 <!-- OUR TESTIMONIAL SECTION START  -->
            <div class="section-full bg-gray bg-repeat p-t100 p-b70" style="background-image:url('{{ asset('assets/images/background/bg-6.jpg') }}');">
            	<div class="container">
                    <!-- TITLE START-->
                        ...
                        <div class="owl-carousel home-carousel-1 m-b30">
                                ...
                                <div class="testimonial-5 bg-white radius-sm">
                                	<div class="testimonial-pic-block radius-bx">
                                    	<div class="testimonial-pic radius">
                                        	<img src="{{ asset('assets/images/testimonials/pic1.jpg') }}" width="132" height="132" alt="">
                                        </div>
                                    </div>
                            ...
                            <div class="item">
                                <div class=" testimonial-5 bg-white radius-sm">
                                	<div class="testimonial-pic-block radius-bx">
                                    	<div class="testimonial-pic radius">
                                        	<img src="{{ asset('assets/images/testimonials/pic2.jpg') }}" width="132" height="132" alt="">
                                        </div>
                                    </div>
                                    <div class="testimonial-text clearfix">
                                        <div class="testimonial-paragraph">
